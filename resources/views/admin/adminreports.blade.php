...
@section('title', 'Semua Laporan - Sapa Sketsu')
                ...
                <form action="{{ Auth::user()->role == 'admin' ? route('admin.reports') : route('user.reports-all') }}" method="GET"
                    ...
                    <div class="sm:col-span-2 lg:col-span-2 flex items-end gap-2">
                        ...
                        @if (request('search') || request('status') || request('category'))
                            <a href="{{ Auth::user()->role == 'admin' ? route('admin.reports') : route('user.reports-all') }}"
                            ...
                            <tr class="hover:bg-slate-50/50 transition">
                                ...
                                <td class="px-5 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        @if ($item->status == 'pending' && Auth::user()->role == 'user')
